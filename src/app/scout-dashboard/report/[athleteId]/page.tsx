...
function AIAnalysisSection({ athlete, idToken }: { athlete: AthleteProfile; idToken: string }) {
      ...
      {report && !loading && (
        <div className="space-y-5 mt-2">
          ...
          <p className="text-[10px] text-slate-400 text-center pt-1">
            AI analysis generated by Talent Graph × Gemini 2.5 Flash · Not a substitute for live scouting
          </p>
        </div>
      )}
    </div>
      ...
      <div className="min-h-screen bg-slate-50 report-root">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8 space-y-0">
          <div className="bg-white rounded-t-2xl shadow-sm overflow-hidden border border-slate-200">
            ...
            {/* ── AI SCOUT ANALYSIS ── */}
            {idToken && <AIAnalysisSection athlete={athlete} idToken={idToken} />}
